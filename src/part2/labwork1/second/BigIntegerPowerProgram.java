...
public class BigIntegerPowerProgram {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nResults:");
        try {
            BigIntegerPower.ResultAndDurationPair resultUsingPow = calculateAndMeasureTime(base, exponent, BigIntegerPower::powerUsingPowFunction);
            ...
            BigIntegerPower.ResultAndDurationPair resultUsingMultiplication = calculateAndMeasureTime(base, exponent, BigIntegerPower::powerUsingMultiplication);
