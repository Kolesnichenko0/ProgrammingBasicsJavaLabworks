...
public class Day implements Comparable<Day>, Serializable {
    ...
    /**
     * The constructor initialises the object with the specified value of date.
     *
     * @param date        the date
     */
    ...
    /**
     * Checks if a word is in the comment.
     *
     * @param word the word to check
     * @return {@code true} if the word is in the comment, {@code false} otherwise
     */
    ...
    /**
     * Checks if a fragment is in a word in the comment.
     *
     * @param fragment the fragment to check
     * @return {@code true} if the fragment is in a word in the comment, {@code false} otherwise
     */
    public boolean isFragmentOfWordInComment(String fragment) {
        Pattern pattern = Pattern.compile("\\b\\p{L}*" + fragment + "\\p{L}*\\b");
        Matcher matcher = pattern.matcher(getComment());
        return matcher.find();
    }

    /**
     * Checks if a fragment is at the start of a word in the comment.
     *
     * @param fragment the fragment to check
     * @return {@code true} if the fragment is at the start of a word in the comment, {@code false} otherwise
     */
